...
How do age, gender, and marital status influence the feedback and usage frequency of online food services?
...
age_feedback <- online_foods_clean %>%
  ...
  mutate(Total = sum(Count),  
         Percent = (Count / Total) * 100)  # Percentage calculated within each Age_Category

# Visualizing the feedback by Age Category with percentage annotations
